/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mirror-channel.jsonc` (hash: 96dfd81e474d332d479c1bbefa3e8023)
// Runtime types generated with workerd@1.20260630.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	YOUTUBE_API_KEY: SecretsStoreSecret;
	...
	ITEM_WORKFLOW: Workflow /* MirrorItemWorkflow from mirror-item */;
	DELETE_CHECK_WORKFLOW: Workflow /* MirrorDeleteWorkflow from mirror-delete */;
	PROFILE_SYNC_WORKFLOW: Workflow /* MirrorProfileWorkflow from mirror-profile */;
}
