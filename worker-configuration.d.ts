/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mirror-channel.jsonc` (hash: cd204b893873b97734f7cc59283f4465)
...
interface __BaseEnv_Env {
	...
	CHANNEL_WORKFLOW: Workflow<Parameters<import("./worker/mirror-channel").MirrorChannelWorkflow['run']>[0]['payload']>;
	ITEM_WORKFLOW: Workflow /* MirrorItemWorkflow from youtube-mirror-item */;
	DELETE_CHECK_WORKFLOW: Workflow /* MirrorDeleteWorkflow from youtube-mirror-delete */;
	PROFILE_SYNC_WORKFLOW: Workflow /* MirrorProfileWorkflow from youtube-mirror-profile */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/mirror-channel");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OIDC_ISSUER_URL" | "OIDC_SIGNING_KID" | "GCP_WORKLOAD_PROVIDER" | "GCP_SERVICE_ACCOUNT" | "OP_SERVICE_ACCOUNT_TOKEN">> {}
}
